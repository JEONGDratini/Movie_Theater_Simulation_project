...
$id = $_GET['CUS_ID'];
$RES = $_GET['RESERVATION_NUM'];
//상영관번호 가져오기

$sql = "SELECT ticket.THEATER_NUM  FROM customer, pay, reservation, ticket, seat
        WHERE customer.CUS_ID = '$id' and customer.CUS_ID = pay.CUS_ID and pay.RESERVATION_NUM = reservation.RESERVATION_NUM and pay.RESERVATION_NUM = '$RES'
